...
export default function OrderDetailsPage({ params }: { params: { id: string } }) {
  ...
  if (!order) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center space-y-4">
        ...
        <Link href="/" className="inline-flex px-6 py-2.5 bg-brand-primary text-white text-xs font-bold rounded-xl">
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 print:p-0">
      {/* Celebratory Banner */}
      <div className="bg-gradient-to-r from-brand-primary via-blue-900 to-brand-secondary text-white p-6 sm:p-8 rounded-3xl shadow-xl space-y-2 text-center print:hidden">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-3xl border border-blue-100 shadow-sm space-y-6 print:hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-4 border-b border-gray-100">
          ...
          <span className="text-xs font-bold text-brand-primary bg-blue-50 px-3 py-1.5 rounded-xl border border-blue-200 self-start sm:self-auto">
      ...
      <div className="bg-white p-6 sm:p-10 rounded-3xl border border-blue-100 shadow-sm space-y-8 print:border-none print:shadow-none">
        {/* Invoice Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Email: <strong>tndeliveryqns@gmail.com</strong> | WhatsApp: <strong>+91 91760 96102</strong>
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-end">
          <div className="w-full sm:w-72 space-y-2 text-xs text-gray-600">
            ...
            <div className="flex justify-between text-base font-extrabold text-gray-900 pt-2 border-t border-gray-200 font-heading">
              ...
              <span className="text-brand-primary">{formatINR(order.total)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-gray-200 flex flex-wrap items-center justify-between gap-4 print:hidden">
          ...
          <Link
            href="/products"
            className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-brand-primary to-brand-secondary text-white font-bold text-xs flex items-center gap-2 hover:opacity-95 transition-opacity"
          >
